...
PHP_METHOD(php_wxWindow, SetDoubleBuffered);
...
PHP_METHOD(php_wxListBox, Refresh);
...
PHP_METHOD(php_wxTextCtrl, PositionToCoords);
...
PHP_METHOD(php_wxSlider, SetTickFreq);
PHP_METHOD(php_wxSlider, SetTick);
PHP_METHOD(php_wxSlider, SetThumbLength);
PHP_METHOD(php_wxSlider, SetSelection);
...
PHP_METHOD(php_wxSlider, GetTickFreq);
PHP_METHOD(php_wxSlider, GetThumbLength);
PHP_METHOD(php_wxSlider, GetSelStart);
PHP_METHOD(php_wxSlider, GetSelEnd);
PHP_METHOD(php_wxSlider, ClearSel);
PHP_METHOD(php_wxSlider, ClearTicks);
...
PHP_METHOD(php_wxMouseCaptureLostEvent, __construct);
PHP_METHOD(php_wxMouseCaptureChangedEvent, GetCapturedWindow);
PHP_METHOD(php_wxMouseCaptureChangedEvent, __construct);
...
PHP_METHOD(php_wxHtmlListBox, Connect);
...
PHP_METHOD(php_wxVListBox, Connect);
PHP_METHOD(php_wxVScrolledWindow, Create);
PHP_METHOD(php_wxVScrolledWindow, __construct);
PHP_METHOD(php_wxVScrolledWindow, Connect);
...
PHP_METHOD(php_wxSimpleHtmlListBox, Connect);
...
PHP_METHOD(php_wxThreadHelper, __construct);
PHP_METHOD(php_wxThreadHelper, GetThread);
PHP_METHOD(php_wxThreadHelper, Entry);
...
PHP_METHOD(php_wxComboCtrl, SetValueWithEvent);
...
PHP_METHOD(php_wxDataViewCtrl, StartEditor);
...
PHP_METHOD(php_wxDataViewListModel, Compare);
...
PHP_METHOD(php_wxIconizeEvent, Iconized);
...
PHP_METHOD(php_wxVarVScrollHelper, EstimateTotalHeight);
PHP_METHOD(php_wxVarVScrollHelper, GetRowCount);
PHP_METHOD(php_wxVarVScrollHelper, GetVisibleRowsBegin);
PHP_METHOD(php_wxVarVScrollHelper, GetVisibleRowsEnd);
PHP_METHOD(php_wxVarVScrollHelper, IsRowVisible);
PHP_METHOD(php_wxVarVScrollHelper, OnGetRowHeight);
PHP_METHOD(php_wxVarVScrollHelper, OnGetRowsHeightHint);
PHP_METHOD(php_wxVarVScrollHelper, RefreshRow);
PHP_METHOD(php_wxVarVScrollHelper, RefreshRows);
PHP_METHOD(php_wxVarVScrollHelper, ScrollRowPages);
PHP_METHOD(php_wxVarVScrollHelper, ScrollRows);
PHP_METHOD(php_wxVarVScrollHelper, ScrollToRow);
PHP_METHOD(php_wxVarVScrollHelper, SetRowCount);
PHP_METHOD(php_wxVarVScrollHelper, __construct);
PHP_METHOD(php_wxVarScrollHelperBase, CalcScrolledPosition);
PHP_METHOD(php_wxVarScrollHelperBase, CalcUnscrolledPosition);
PHP_METHOD(php_wxVarScrollHelperBase, EnablePhysicalScrolling);
PHP_METHOD(php_wxVarScrollHelperBase, EstimateTotalSize);
PHP_METHOD(php_wxVarScrollHelperBase, GetNonOrientationTargetSize);
PHP_METHOD(php_wxVarScrollHelperBase, GetOrientation);
PHP_METHOD(php_wxVarScrollHelperBase, GetOrientationTargetSize);
PHP_METHOD(php_wxVarScrollHelperBase, GetTargetWindow);
PHP_METHOD(php_wxVarScrollHelperBase, GetVisibleBegin);
PHP_METHOD(php_wxVarScrollHelperBase, GetVisibleEnd);
PHP_METHOD(php_wxVarScrollHelperBase, IsVisible);
PHP_METHOD(php_wxVarScrollHelperBase, OnGetUnitSize);
PHP_METHOD(php_wxVarScrollHelperBase, OnGetUnitsSizeHint);
PHP_METHOD(php_wxVarScrollHelperBase, RefreshAll);
PHP_METHOD(php_wxVarScrollHelperBase, SetTargetWindow);
PHP_METHOD(php_wxVarScrollHelperBase, UpdateScrollbar);
PHP_METHOD(php_wxVarScrollHelperBase, VirtualHitTest);
PHP_METHOD(php_wxVarScrollHelperBase, __construct);
...
PHP_METHOD(php_wxVarHScrollHelper, EstimateTotalWidth);
PHP_METHOD(php_wxVarHScrollHelper, GetColumnCount);
PHP_METHOD(php_wxVarHScrollHelper, GetVisibleColumnsBegin);
PHP_METHOD(php_wxVarHScrollHelper, GetVisibleColumnsEnd);
PHP_METHOD(php_wxVarHScrollHelper, IsColumnVisible);
PHP_METHOD(php_wxVarHScrollHelper, OnGetColumnWidth);
PHP_METHOD(php_wxVarHScrollHelper, OnGetColumnsWidthHint);
PHP_METHOD(php_wxVarHScrollHelper, RefreshColumn);
PHP_METHOD(php_wxVarHScrollHelper, RefreshColumns);
PHP_METHOD(php_wxVarHScrollHelper, ScrollColumnPages);
PHP_METHOD(php_wxVarHScrollHelper, ScrollColumns);
PHP_METHOD(php_wxVarHScrollHelper, ScrollToColumn);
PHP_METHOD(php_wxVarHScrollHelper, SetColumnCount);
PHP_METHOD(php_wxVarHScrollHelper, __construct);
PHP_METHOD(php_wxVarHVScrollHelper, GetRowColumnCount);
PHP_METHOD(php_wxVarHVScrollHelper, RefreshRowColumn);
PHP_METHOD(php_wxVarHVScrollHelper, RefreshRowsColumns);
PHP_METHOD(php_wxVarHVScrollHelper, ScrollToRowColumn);
PHP_METHOD(php_wxVarHVScrollHelper, SetRowColumnCount);
...
PHP_METHOD(php_wxShowEvent, GetShow);
...
PHP_METHOD(php_wxJoystick, GetButtonState);
PHP_METHOD(php_wxJoystick, GetManufacturerId);
PHP_METHOD(php_wxJoystick, GetMovementThreshold);
PHP_METHOD(php_wxJoystick, GetNumberAxes);
PHP_METHOD(php_wxJoystick, GetNumberButtons);
PHP_METHOD(php_wxJoystick, GetPOVCTSPosition);
PHP_METHOD(php_wxJoystick, GetPOVPosition);
PHP_METHOD(php_wxJoystick, GetPollingMax);
PHP_METHOD(php_wxJoystick, GetNumberJoysticks);
PHP_METHOD(php_wxJoystick, GetPollingMin);
PHP_METHOD(php_wxJoystick, GetPosition);
PHP_METHOD(php_wxJoystick, GetProductId);
PHP_METHOD(php_wxJoystick, GetProductName);
PHP_METHOD(php_wxJoystick, GetRudderMax);
PHP_METHOD(php_wxJoystick, GetRudderMin);
PHP_METHOD(php_wxJoystick, GetRudderPosition);
PHP_METHOD(php_wxJoystick, GetUMax);
PHP_METHOD(php_wxJoystick, GetUMin);
PHP_METHOD(php_wxJoystick, GetUPosition);
PHP_METHOD(php_wxJoystick, GetVMax);
PHP_METHOD(php_wxJoystick, GetVMin);
PHP_METHOD(php_wxJoystick, GetVPosition);
PHP_METHOD(php_wxJoystick, GetXMax);
PHP_METHOD(php_wxJoystick, GetXMin);
PHP_METHOD(php_wxJoystick, GetYMax);
PHP_METHOD(php_wxJoystick, GetYMin);
PHP_METHOD(php_wxJoystick, GetZMax);
PHP_METHOD(php_wxJoystick, GetZMin);
PHP_METHOD(php_wxJoystick, GetZPosition);
PHP_METHOD(php_wxJoystick, HasPOV);
PHP_METHOD(php_wxJoystick, HasPOV4Dir);
PHP_METHOD(php_wxJoystick, HasPOVCTS);
PHP_METHOD(php_wxJoystick, HasRudder);
PHP_METHOD(php_wxJoystick, HasU);
PHP_METHOD(php_wxJoystick, HasV);
PHP_METHOD(php_wxJoystick, HasZ);
PHP_METHOD(php_wxJoystick, IsOk);
PHP_METHOD(php_wxJoystick, ReleaseCapture);
PHP_METHOD(php_wxJoystick, SetCapture);
PHP_METHOD(php_wxJoystick, SetMovementThreshold);
PHP_METHOD(php_wxJoystick, __construct);
PHP_METHOD(php_wxJoystickEvent, ButtonDown);
PHP_METHOD(php_wxJoystickEvent, ButtonIsDown);
PHP_METHOD(php_wxJoystickEvent, ButtonUp);
PHP_METHOD(php_wxJoystickEvent, GetButtonChange);
PHP_METHOD(php_wxJoystickEvent, GetButtonState);
PHP_METHOD(php_wxJoystickEvent, GetJoystick);
PHP_METHOD(php_wxJoystickEvent, GetPosition);
PHP_METHOD(php_wxJoystickEvent, GetZPosition);
PHP_METHOD(php_wxJoystickEvent, IsButton);
PHP_METHOD(php_wxJoystickEvent, IsMove);
PHP_METHOD(php_wxJoystickEvent, IsZMove);
PHP_METHOD(php_wxJoystickEvent, __construct);
