...
class MainWindow extends wxFrame {
    ...
    function __construct($parent=null)
    {
        ...
        $this->m_staticText1 = new wxStaticText(
            $this,
            wxID_ANY,
            "Drop Text:",
            wxDefaultPosition,
        ...
        $this->m_textCtrl1 = new wxTextCtrl(
            $this,
            wxID_ANY,
            wxEmptyString,
            wxDefaultPosition,
        ...
        $this->m_staticText11 = new wxStaticText(
            $this,
            wxID_ANY,
            "Drop Files:",
            wxDefaultPosition,
        ...
        $this->m_textCtrl11 = new wxTextCtrl(
            $this,
            wxID_ANY,
            wxEmptyString,
            wxDefaultPosition,
        ...
        $this->m_menuItem1 = new wxMenuItem(
            $this->m_menu1,
            wxID_ANY,
            "&Quit",
            wxEmptyString,
        ...
        // Connect Events
        $this->Connect(
            $this->m_menuItem1->GetId(),
            wxEVT_COMMAND_MENU_SELECTED,
            array($this, "CloseWindow")
        );
    }
