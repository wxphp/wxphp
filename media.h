...
#define PHP_wxSound_NAME "wxSound"
#define le_wxSound_name  "native wxSound"
...
static function_entry php_wxSound_functions[] = {
	...
	PHP_ME(php_wxSound, IsPlaying, NULL, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
