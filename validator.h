...
#define PHP_wxGenericValidator_NAME "wxGenericValidator"
#define le_wxGenericValidator_name  "native wxGenericValidator"
...
static function_entry php_wxGenericValidator_functions[] = {
...
#define PHP_wxTextValidator_NAME "wxTextValidator"
#define le_wxTextValidator_name  "native wxTextValidator"
...
static function_entry php_wxTextValidator_functions[] = {
	PHP_ME(php_wxObject, UnShare, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxObject, UnRef, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxObject, IsSameAs, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxObject, Ref, NULL, ZEND_ACC_PUBLIC)
