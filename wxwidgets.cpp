...
PHP_MINIT_FUNCTION(php_wxWidgets)
{
	...
	ce.create_object = php_wxGridCellCoords_new;
	...
	ce.create_object = php_wxMediaCtrl_new;
	php_wxMediaCtrl_entry = zend_register_internal_class(&ce TSRMLS_CC);

	char PHP_wxURI_name[] = "wxURI";
	INIT_CLASS_ENTRY(ce, PHP_wxURI_name, php_wxURI_functions);
	ce.create_object = php_wxURI_new;
	...
	REGISTER_LONG_CONSTANT("wxWEBKIT_NAV_BACK_NEXT", wxWEBKIT_NAV_BACK_NEXT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_NAV_FORM_RESUBMITTED", wxWEBKIT_NAV_FORM_RESUBMITTED, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_NAV_FORM_SUBMITTED", wxWEBKIT_NAV_FORM_SUBMITTED, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_NAV_LINK_CLICKED", wxWEBKIT_NAV_LINK_CLICKED, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_NAV_OTHER", wxWEBKIT_NAV_OTHER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_NAV_RELOAD", wxWEBKIT_NAV_RELOAD, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_STATE_FAILED", wxWEBKIT_STATE_FAILED, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_STATE_NEGOTIATING", wxWEBKIT_STATE_NEGOTIATING, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_STATE_REDIRECTING", wxWEBKIT_STATE_REDIRECTING, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_STATE_START", wxWEBKIT_STATE_START, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_STATE_STOP", wxWEBKIT_STATE_STOP, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWEBKIT_STATE_TRANSFERRING", wxWEBKIT_STATE_TRANSFERRING, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("wxEVT_WEBKIT_STATE_CHANGED", wxEVT_WEBKIT_STATE_CHANGED, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxEVT_WEBKIT_BEFORE_LOAD", wxEVT_WEBKIT_BEFORE_LOAD, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxEVT_WEBKIT_NEW_WINDOW", wxEVT_WEBKIT_NEW_WINDOW, CONST_CS | CONST_PERSISTENT);
