...
PHP_MINIT_FUNCTION(php_wxWidgets)
{
	...
	le_wxTextCompleterSimple = zend_register_list_destructors_ex(php_wxTextCompleterSimple_destruction_handler, NULL, (char*) "native wxTextCompleterSimple", module_number);
