...
static zend_function_entry php_wxWidgets_functions[] = {
     ...
     */
    PHP_FALIAS(wxHandleFatalExceptions, php_wxHandleFatalExceptions, arginfo_void)
    PHP_FALIAS(wxInitialize, php_wxInitialize, arginfo_void)
    PHP_FALIAS(wxUninitialize, php_wxUninitialize, arginfo_void)
    PHP_FALIAS(wxWakeUpIdle, php_wxWakeUpIdle, arginfo_void)
    PHP_FALIAS(wxSafeYield, php_wxSafeYield, arginfo_void)
    PHP_FALIAS(wxExit, php_wxExit, arginfo_void)
    PHP_FALIAS(wxIsDragResultOk, php_wxIsDragResultOk, arginfo_void)
    PHP_FALIAS(wxFromString, php_wxFromString, arginfo_void)
    PHP_FALIAS(wxToString, php_wxToString, arginfo_void)
    PHP_FALIAS(wxSafeShowMessage, php_wxSafeShowMessage, arginfo_void)
    PHP_FALIAS(wxSysErrorCode, php_wxSysErrorCode, arginfo_void)
    PHP_FALIAS(wxIsMainThread, php_wxIsMainThread, arginfo_void)
    PHP_FALIAS(wxMutexGuiEnter, php_wxMutexGuiEnter, arginfo_void)
    PHP_FALIAS(wxMutexGuiLeave, php_wxMutexGuiLeave, arginfo_void)
    PHP_FALIAS(wxAboutBox, php_wxAboutBox, arginfo_void)
    PHP_FALIAS(wxBase64Encode, php_wxBase64Encode, arginfo_void)
    PHP_FALIAS(wxBase64DecodedSize, php_wxBase64DecodedSize, arginfo_void)
    PHP_FALIAS(wxBase64EncodedSize, php_wxBase64EncodedSize, arginfo_void)
    PHP_FALIAS(wxBase64Decode, php_wxBase64Decode, arginfo_void)
    PHP_FALIAS(wxGetSingleChoiceIndex, php_wxGetSingleChoiceIndex, arginfo_void)
    PHP_FALIAS(wxGetSingleChoice, php_wxGetSingleChoice, arginfo_void)
    PHP_FALIAS(wxGetColourFromUser, php_wxGetColourFromUser, arginfo_void)
    PHP_FALIAS(wxAutoBufferedPaintDCFactory, php_wxAutoBufferedPaintDCFactory, arginfo_void)
    PHP_FALIAS(wxAbort, php_wxAbort, arginfo_void)
    PHP_FALIAS(wxDisableAsserts, php_wxDisableAsserts, arginfo_void)
    PHP_FALIAS(wxIsDebuggerRunning, php_wxIsDebuggerRunning, arginfo_void)
    PHP_FALIAS(wxSetDefaultAssertHandler, php_wxSetDefaultAssertHandler, arginfo_void)
    PHP_FALIAS(wxTrap, php_wxTrap, arginfo_void)
    PHP_FALIAS(wxDirSelector, php_wxDirSelector, arginfo_void)
    PHP_FALIAS(wxNewEventType, php_wxNewEventType, arginfo_void)
    PHP_FALIAS(wxPostEvent, php_wxPostEvent, arginfo_void)
    PHP_FALIAS(wxQueueEvent, php_wxQueueEvent, arginfo_void)
    PHP_FALIAS(wxFileSelector, php_wxFileSelector, arginfo_void)
    PHP_FALIAS(wxFileSelectorEx, php_wxFileSelectorEx, arginfo_void)
    PHP_FALIAS(wxLoadFileSelector, php_wxLoadFileSelector, arginfo_void)
    PHP_FALIAS(wxSaveFileSelector, php_wxSaveFileSelector, arginfo_void)
    PHP_FALIAS(wxGetOSDirectory, php_wxGetOSDirectory, arginfo_void)
    PHP_FALIAS(wxParseCommonDialogsFilter, php_wxParseCommonDialogsFilter, arginfo_void)
    PHP_FALIAS(wxDirExists, php_wxDirExists, arginfo_void)
    PHP_FALIAS(wxRenameFile, php_wxRenameFile, arginfo_void)
    PHP_FALIAS(wxCopyFile, php_wxCopyFile, arginfo_void)
    PHP_FALIAS(wxFileExists, php_wxFileExists, arginfo_void)
    PHP_FALIAS(wxMatchWild, php_wxMatchWild, arginfo_void)
    PHP_FALIAS(wxPathOnly, php_wxPathOnly, arginfo_void)
    PHP_FALIAS(wxIsWild, php_wxIsWild, arginfo_void)
    PHP_FALIAS(wxIsAbsolutePath, php_wxIsAbsolutePath, arginfo_void)
    PHP_FALIAS(wxGetCwd, php_wxGetCwd, arginfo_void)
    PHP_FALIAS(wxSetWorkingDirectory, php_wxSetWorkingDirectory, arginfo_void)
    PHP_FALIAS(wxConcatFiles, php_wxConcatFiles, arginfo_void)
    PHP_FALIAS(wxRemoveFile, php_wxRemoveFile, arginfo_void)
    PHP_FALIAS(wxMkdir, php_wxMkdir, arginfo_void)
    PHP_FALIAS(wxRmdir, php_wxRmdir, arginfo_void)
    PHP_FALIAS(wxFindNextFile, php_wxFindNextFile, arginfo_void)
    PHP_FALIAS(wxFindFirstFile, php_wxFindFirstFile, arginfo_void)
    PHP_FALIAS(wxGetFileKind, php_wxGetFileKind, arginfo_void)
    PHP_FALIAS(wxGetFontFromUser, php_wxGetFontFromUser, arginfo_void)
    PHP_FALIAS(wxColourDisplay, php_wxColourDisplay, arginfo_void)
    PHP_FALIAS(wxDisplayDepth, php_wxDisplayDepth, arginfo_void)
    PHP_FALIAS(wxSetCursor, php_wxSetCursor, arginfo_void)
    PHP_FALIAS(wxClientDisplayRect, php_wxClientDisplayRect, arginfo_void)
    PHP_FALIAS(wxGetClientDisplayRect, php_wxGetClientDisplayRect, arginfo_void)
    PHP_FALIAS(wxGetDisplayPPI, php_wxGetDisplayPPI, arginfo_void)
    PHP_FALIAS(wxDisplaySize, php_wxDisplaySize, arginfo_void)
    PHP_FALIAS(wxGetDisplaySize, php_wxGetDisplaySize, arginfo_void)
    PHP_FALIAS(wxDisplaySizeMM, php_wxDisplaySizeMM, arginfo_void)
    PHP_FALIAS(wxGetDisplaySizeMM, php_wxGetDisplaySizeMM, arginfo_void)
    PHP_FALIAS(wxInitAllImageHandlers, php_wxInitAllImageHandlers, arginfo_void)
    PHP_FALIAS(wxEntryCleanup, php_wxEntryCleanup, arginfo_void)
    PHP_FALIAS(wxFinite, php_wxFinite, arginfo_void)
    PHP_FALIAS(wxIsNaN, php_wxIsNaN, arginfo_void)
    PHP_FALIAS(wxRound, php_wxRound, arginfo_void)
    PHP_FALIAS(wxIsSameDouble, php_wxIsSameDouble, arginfo_void)
    PHP_FALIAS(wxIsNullDouble, php_wxIsNullDouble, arginfo_void)
    PHP_FALIAS(wxMessageBox, php_wxMessageBox, arginfo_void)
    PHP_FALIAS(wxGetNumberFromUser, php_wxGetNumberFromUser, arginfo_void)
    PHP_FALIAS(wxCreateDynamicObject, php_wxCreateDynamicObject, arginfo_void)
    PHP_FALIAS(wxFindWindowAtPointer, php_wxFindWindowAtPointer, arginfo_void)
    PHP_FALIAS(wxGetActiveWindow, php_wxGetActiveWindow, arginfo_void)
    PHP_FALIAS(wxGetTopLevelParent, php_wxGetTopLevelParent, arginfo_void)
    PHP_FALIAS(wxRichTextHasStyle, php_wxRichTextHasStyle, arginfo_void)
    PHP_FALIAS(wxRichTextCombineBitlists, php_wxRichTextCombineBitlists, arginfo_void)
    PHP_FALIAS(wxRichTextBitlistsEqPartial, php_wxRichTextBitlistsEqPartial, arginfo_void)
    PHP_FALIAS(wxRichTextDecimalToRoman, php_wxRichTextDecimalToRoman, arginfo_void)
    PHP_FALIAS(wxTextAttrCollectCommonAttributes, php_wxTextAttrCollectCommonAttributes, arginfo_void)
    PHP_FALIAS(wxRichTextModuleInit, php_wxRichTextModuleInit, arginfo_void)
    PHP_FALIAS(wxGetStockLabel, php_wxGetStockLabel, arginfo_void)
    PHP_FALIAS(wxGetTextFromUser, php_wxGetTextFromUser, arginfo_void)
    PHP_FALIAS(wxGetPasswordFromUser, php_wxGetPasswordFromUser, arginfo_void)
    PHP_FALIAS(wxGetTimeZone, php_wxGetTimeZone, arginfo_void)
    PHP_FALIAS(wxGetLocalTime, php_wxGetLocalTime, arginfo_void)
    PHP_FALIAS(wxGetUTCTime, php_wxGetUTCTime, arginfo_void)
    PHP_FALIAS(wxStringTokenize, php_wxStringTokenize, arginfo_void)
    PHP_FALIAS(wxGetTranslation, php_wxGetTranslation, arginfo_void)
    PHP_FALIAS(wxBeginBusyCursor, php_wxBeginBusyCursor, arginfo_void)
    PHP_FALIAS(wxEndBusyCursor, php_wxEndBusyCursor, arginfo_void)
    PHP_FALIAS(wxIsBusy, php_wxIsBusy, arginfo_void)
    PHP_FALIAS(wxBell, php_wxBell, arginfo_void)
    PHP_FALIAS(wxInfoMessageBox, php_wxInfoMessageBox, arginfo_void)
    PHP_FALIAS(wxGetLibraryVersionInfo, php_wxGetLibraryVersionInfo, arginfo_void)
    PHP_FALIAS(wxGetenv, php_wxGetenv, arginfo_void)
    PHP_FALIAS(wxSetEnv, php_wxSetEnv, arginfo_void)
    PHP_FALIAS(wxUnsetEnv, php_wxUnsetEnv, arginfo_void)
    PHP_FALIAS(wxGetBatteryState, php_wxGetBatteryState, arginfo_void)
    PHP_FALIAS(wxGetPowerType, php_wxGetPowerType, arginfo_void)
    PHP_FALIAS(wxGetKeyState, php_wxGetKeyState, arginfo_void)
    PHP_FALIAS(wxGetMousePosition, php_wxGetMousePosition, arginfo_void)
    PHP_FALIAS(wxGetMouseState, php_wxGetMouseState, arginfo_void)
    PHP_FALIAS(wxEnableTopLevelWindows, php_wxEnableTopLevelWindows, arginfo_void)
    PHP_FALIAS(wxFindWindowAtPoint, php_wxFindWindowAtPoint, arginfo_void)
    PHP_FALIAS(wxFindMenuItemId, php_wxFindMenuItemId, arginfo_void)
    PHP_FALIAS(wxRegisterId, php_wxRegisterId, arginfo_void)
    PHP_FALIAS(wxLaunchDefaultApplication, php_wxLaunchDefaultApplication, arginfo_void)
    PHP_FALIAS(wxLaunchDefaultBrowser, php_wxLaunchDefaultBrowser, arginfo_void)
    PHP_FALIAS(wxStripMenuCodes, php_wxStripMenuCodes, arginfo_void)
    PHP_FALIAS(wxGetHomeDir, php_wxGetHomeDir, arginfo_void)
    PHP_FALIAS(wxGetFullHostName, php_wxGetFullHostName, arginfo_void)
    PHP_FALIAS(wxGetUserHome, php_wxGetUserHome, arginfo_void)
    PHP_FALIAS(wxGetOsDescription, php_wxGetOsDescription, arginfo_void)
    PHP_FALIAS(wxGetOsVersion, php_wxGetOsVersion, arginfo_void)
    PHP_FALIAS(wxIsPlatform64Bit, php_wxIsPlatform64Bit, arginfo_void)
    PHP_FALIAS(wxIsPlatformLittleEndian, php_wxIsPlatformLittleEndian, arginfo_void)
    PHP_FALIAS(wxGetProcessId, php_wxGetProcessId, arginfo_void)
    PHP_FALIAS(wxKill, php_wxKill, arginfo_void)
    PHP_FALIAS(wxShell, php_wxShell, arginfo_void)
    PHP_FALIAS(wxShutdown, php_wxShutdown, arginfo_void)
    PHP_FALIAS(wxMicroSleep, php_wxMicroSleep, arginfo_void)
    PHP_FALIAS(wxMilliSleep, php_wxMilliSleep, arginfo_void)
    PHP_FALIAS(wxNow, php_wxNow, arginfo_void)
    PHP_FALIAS(wxSleep, php_wxSleep, arginfo_void)
    PHP_FALIAS(wxIsEmpty, php_wxIsEmpty, arginfo_void)
    PHP_FALIAS(wxTmemchr, php_wxTmemchr, arginfo_void)
    PHP_FALIAS(wxTmemcmp, php_wxTmemcmp, arginfo_void)
    PHP_FALIAS(wxTmemcpy, php_wxTmemcpy, arginfo_void)
    PHP_FALIAS(wxTmemmove, php_wxTmemmove, arginfo_void)
    PHP_FALIAS(wxTmemset, php_wxTmemset, arginfo_void)
    PHP_FALIAS(wxSetlocale, php_wxSetlocale, arginfo_void)
    PHP_FALIAS(wxStrlen, php_wxStrlen, arginfo_void)
    PHP_FALIAS(wxStrnlen, php_wxStrnlen, arginfo_void)
    PHP_FALIAS(wxStrdup, php_wxStrdup, arginfo_void)
    PHP_FALIAS(wxStrcpy, php_wxStrcpy, arginfo_void)
    PHP_FALIAS(wxStrncpy, php_wxStrncpy, arginfo_void)
    PHP_FALIAS(wxStrlcpy, php_wxStrlcpy, arginfo_void)
    PHP_FALIAS(wxStrcat, php_wxStrcat, arginfo_void)
    PHP_FALIAS(wxStrncat, php_wxStrncat, arginfo_void)
    PHP_FALIAS(wxStrxfrm, php_wxStrxfrm, arginfo_void)
    PHP_FALIAS(wxStrstr, php_wxStrstr, arginfo_void)
    PHP_FALIAS(wxStrchr, php_wxStrchr, arginfo_void)
    PHP_FALIAS(wxStrrchr, php_wxStrrchr, arginfo_void)
    PHP_FALIAS(wxStrpbrk, php_wxStrpbrk, arginfo_void)
    PHP_FALIAS(wxRemove, php_wxRemove, arginfo_void)
    PHP_FALIAS(wxRename, php_wxRename, arginfo_void)
    PHP_FALIAS(wxAtoi, php_wxAtoi, arginfo_void)
    PHP_FALIAS(wxAtol, php_wxAtol, arginfo_void)
    PHP_FALIAS(wxAtof, php_wxAtof, arginfo_void)
    PHP_FALIAS(wxSystem, php_wxSystem, arginfo_void)
    PHP_FALIAS(wxDynamicCast, php_wxDynamicCast, arginfo_void)
