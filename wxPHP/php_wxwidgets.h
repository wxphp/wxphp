...
PHP_METHOD(php_wxGrid, DoEndDragMoveCol);
PHP_METHOD(php_wxGrid, DoEndDragResizeCol);
PHP_METHOD(php_wxGrid, DoEndDragResizeRow);
PHP_METHOD(php_wxGrid, DoGetBestSize);
PHP_METHOD(php_wxGrid, Enable);
