...
// classes --->
	...
	REGISTER_LONG_CONSTANT("wxUNKNOWN_PLATFORM",	wxUNKNOWN_PLATFORM	, CONST_CS |CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxGTK",	wxGTK	, CONST_CS |CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWINDOWS_NT",	wxWINDOWS_NT	, CONST_CS |CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWIN32S",	wxWIN32S	, CONST_CS |CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("wxWIN95",	wxWIN95	, CONST_CS |CONST_PERSISTENT);
