...
int le_wxAuiDefaultDockArt;
zend_class_entry *php_wxAuiMDIParentFrame_entry;
int le_wxAuiMDIParentFrame;
...
INIT_CLASS_ENTRY(cf, PHP_wxAuiDefaultDockArt_NAME , php_wxAuiDefaultDockArt_functions);
php_wxAuiDefaultDockArt_entry = zend_register_internal_class(&cf TSRMLS_CC);
le_wxAuiDefaultDockArt = zend_register_list_destructors_ex(php_wxAuiDefaultDockArt_destruction_handler, NULL, le_wxAuiDefaultDockArt_name, module_number);

INIT_CLASS_ENTRY(cf, PHP_wxAuiMDIParentFrame_NAME , php_wxAuiMDIParentFrame_functions);
php_wxAuiMDIParentFrame_entry = zend_register_internal_class(&cf TSRMLS_CC);
le_wxAuiMDIParentFrame = zend_register_list_destructors_ex(php_wxAuiMDIParentFrame_destruction_handler, NULL, le_wxAuiMDIParentFrame_name, module_number);
...
REGISTER_LONG_CONSTANT("wxAUI_GRADIENT_NONE", wxAUI_GRADIENT_NONE, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxAUI_NB_LEFT", wxAUI_NB_LEFT, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxAUI_NB_RIGHT", wxAUI_NB_RIGHT, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxAUI_NB_MIDDLE_CLICK_CLOSE", wxAUI_NB_MIDDLE_CLICK_CLOSE, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxLAYOUT_NONE", wxLAYOUT_NONE, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxMEDIACTRLPLAYERCONTROLS_VOLUME", wxMEDIACTRLPLAYERCONTROLS_VOLUME, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxMEDIACTRLPLAYERCONTROLS_DEFAULT", wxMEDIACTRLPLAYERCONTROLS_DEFAULT, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxNOTIFY_NONE", wxNOTIFY_NONE, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxNOTIFY_ONCE", wxNOTIFY_ONCE, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxNOTIFY_REPEAT", wxNOTIFY_REPEAT, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxURI_SCHEME", wxURI_SCHEME, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxURI_USERINFO", wxURI_USERINFO, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxURI_SERVER", wxURI_SERVER, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxURI_PORT", wxURI_PORT, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxURI_PATH", wxURI_PATH, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxURI_QUERY", wxURI_QUERY, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxURI_FRAGMENT", wxURI_FRAGMENT, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxAUI_DOCK_NONE", wxAUI_DOCK_NONE, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxGRIDTABLE_REQUEST_VIEW_GET_VALUES", wxGRIDTABLE_REQUEST_VIEW_GET_VALUES, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxGRIDTABLE_REQUEST_VIEW_SEND_VALUES", wxGRIDTABLE_REQUEST_VIEW_SEND_VALUES, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxGRIDTABLE_NOTIFY_ROWS_INSERTED", wxGRIDTABLE_NOTIFY_ROWS_INSERTED, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxGRIDTABLE_NOTIFY_ROWS_APPENDED", wxGRIDTABLE_NOTIFY_ROWS_APPENDED, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxGRIDTABLE_NOTIFY_ROWS_DELETED", wxGRIDTABLE_NOTIFY_ROWS_DELETED, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxGRIDTABLE_NOTIFY_COLS_INSERTED", wxGRIDTABLE_NOTIFY_COLS_INSERTED, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxGRIDTABLE_NOTIFY_COLS_APPENDED", wxGRIDTABLE_NOTIFY_COLS_APPENDED, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxGRIDTABLE_NOTIFY_COLS_DELETED", wxGRIDTABLE_NOTIFY_COLS_DELETED, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxAUI_INSERT_PANE", wxAUI_INSERT_PANE, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxAUI_INSERT_ROW", wxAUI_INSERT_ROW, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxAUI_INSERT_DOCK", wxAUI_INSERT_DOCK, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxURI_STRICT", wxURI_STRICT, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxSASH_NONE", wxSASH_NONE, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxAUI_BUTTON_STATE_DISABLED", wxAUI_BUTTON_STATE_DISABLED, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxAUI_BUTTON_STATE_HIDDEN", wxAUI_BUTTON_STATE_HIDDEN, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxAUI_BUTTON_STATE_CHECKED", wxAUI_BUTTON_STATE_CHECKED, CONST_CS | CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("wxMEDIASTATE_STOPPED", wxMEDIASTATE_STOPPED, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxMEDIASTATE_PAUSED", wxMEDIASTATE_PAUSED, CONST_CS | CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("wxMEDIASTATE_PLAYING", wxMEDIASTATE_PLAYING, CONST_CS | CONST_PERSISTENT);
...
REGISTER_NS_LONG_CONSTANT("wxGrid", "wxGridSelectCells", wxGrid::wxGridSelectCells, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGrid", "wxGridSelectRows", wxGrid::wxGridSelectRows, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGrid", "wxGridSelectColumns", wxGrid::wxGridSelectColumns, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGrid", "wxGRID_CELLCTRL", wxGrid::wxGRID_CELLCTRL, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGrid", "wxGRID_TOPCTRL", wxGrid::wxGRID_TOPCTRL, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGrid", "wxGRID_TEXTCTRL", wxGrid::wxGRID_TEXTCTRL, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGrid", "wxGRID_CHECKBOX", wxGrid::wxGRID_CHECKBOX, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGrid", "wxGRID_CHOICE", wxGrid::wxGRID_CHOICE, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGrid", "wxGRID_COMBOBOX", wxGrid::wxGRID_COMBOBOX, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionFloating", wxAuiPaneInfo::optionFloating, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionHidden", wxAuiPaneInfo::optionHidden, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionLeftDockable", wxAuiPaneInfo::optionLeftDockable, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionRightDockable", wxAuiPaneInfo::optionRightDockable, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionTopDockable", wxAuiPaneInfo::optionTopDockable, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionBottomDockable", wxAuiPaneInfo::optionBottomDockable, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionFloatable", wxAuiPaneInfo::optionFloatable, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionMovable", wxAuiPaneInfo::optionMovable, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionResizable", wxAuiPaneInfo::optionResizable, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionPaneBorder", wxAuiPaneInfo::optionPaneBorder, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionCaption", wxAuiPaneInfo::optionCaption, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionGripper", wxAuiPaneInfo::optionGripper, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionDestroyOnClose", wxAuiPaneInfo::optionDestroyOnClose, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionToolbar", wxAuiPaneInfo::optionToolbar, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionActive", wxAuiPaneInfo::optionActive, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionGripperTop", wxAuiPaneInfo::optionGripperTop, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionMaximized", wxAuiPaneInfo::optionMaximized, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "optionDockFixed", wxAuiPaneInfo::optionDockFixed, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "buttonClose", wxAuiPaneInfo::buttonClose, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "buttonMaximize", wxAuiPaneInfo::buttonMaximize, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "buttonMinimize", wxAuiPaneInfo::buttonMinimize, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "buttonPin", wxAuiPaneInfo::buttonPin, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "buttonCustom1", wxAuiPaneInfo::buttonCustom1, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "buttonCustom2", wxAuiPaneInfo::buttonCustom2, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "buttonCustom3", wxAuiPaneInfo::buttonCustom3, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "savedHiddenState", wxAuiPaneInfo::savedHiddenState, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxAuiPaneInfo", "actionPane", wxAuiPaneInfo::actionPane, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGridCellAttr", "Any", wxGridCellAttr::Any, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGridCellAttr", "Default", wxGridCellAttr::Default, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGridCellAttr", "Cell", wxGridCellAttr::Cell, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGridCellAttr", "Row", wxGridCellAttr::Row, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGridCellAttr", "Col", wxGridCellAttr::Col, CONST_CS | CONST_PERSISTENT);
REGISTER_NS_LONG_CONSTANT("wxGridCellAttr", "Merged", wxGridCellAttr::Merged, CONST_CS | CONST_PERSISTENT);
