...
static function_entry php_wxFrame_functions[] = {
	...
	PHP_ME(php_wxWindowBase, CacheBestSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, CaptureMouse, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, CentreOnParent, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ClientToScreen, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ClientToWindowSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Close, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ConvertDialogToPixels, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ConvertPixelsToDialog, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, DestroyChildren, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Disable, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, DoGetBestSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, DoUpdateWindowUI, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, FitInside, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Freeze, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetAcceleratorTable, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetBackgroundColour, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetBackgroundStyle, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetClientSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetBestSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetCapture, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetCaret, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetChildren, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetConstraints, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetContainingSizer, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetCursor, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetDefaultAttributes, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetEventHandler, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetExtraStyle, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetFont, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetForegroundColour, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetGrandParent, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetHelpText, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetMaxSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetMinSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetName, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetNextSibling, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetParent, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetPosition, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetPrevSibling, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetRect, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetScreenPosition, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetScreenRect, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetScrollPos, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetTextExtent, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Hide, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, IsExposed, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, IsTopLevel, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, LineDown, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, LineUp, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, MakeModal, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, PageDown, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, PageUp, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, PopEventHandler, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, PushEventHandler, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, RefreshRect, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ReleaseMouse, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, RemoveEventHandler, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxTopLevelWindowBase, GetTitle, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, EnableCloseButton, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, GetDefaultItem, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, GetIcon, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, GetIcons, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, IsActive, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, IsAlwaysMaximized, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, IsIconized, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, IsFullScreen, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, IsMaximized, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, SetShape, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, SetIcons, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, SetDefaultItem, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, RequestUserAttention, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, Iconize, NULL, ZEND_ACC_PUBLIC)
...
static function_entry php_wxSize_functions[] = {
	...
	PHP_ME(php_wxSize, GetX, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxSize, GetY, NULL, ZEND_ACC_PUBLIC)
...
class wxWindowBase_php : public wxWindowBase
{
	...
	virtual int GetScrollPos(int arg0)  const;
	virtual int GetScrollRange(int arg0)  const;
	virtual int GetScrollThumb(int arg0)  const;
	virtual void GetTextExtent(const wxString& arg0 , int* arg1 , int* arg2 , int* arg3 , int* arg4 , const wxFont* arg5)  const;
	virtual void Lower() ;
	virtual void Raise() ;
	virtual void Refresh(bool arg0 , const wxRect* arg1) ;
...
static function_entry php_wxWindowBase_functions[] = {
	...
	PHP_ME(php_wxWindowBase, CaptureMouse, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, CentreOnParent, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ClearBackground, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ClientToScreen, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ClientToWindowSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Close, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ConvertDialogToPixels, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxWindowBase, GetCapture, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetCaret, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetCharHeight, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetCharWidth, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetChildren, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetConstraints, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetContainingSizer, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetCursor, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxWindowBase, GetScreenRect, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetScrollPos, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetScrollRange, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetScrollThumb, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetTextExtent, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Hide, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, IsExposed, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, IsFrozen, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, IsRetained, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, IsTopLevel, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, LineDown, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, LineUp, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Lower, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, MakeModal, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, PageDown, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, PageUp, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, PopEventHandler, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, PushEventHandler, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Raise, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Refresh, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, RefreshRect, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, ReleaseMouse, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, RemoveChild, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, RemoveEventHandler, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Reparent, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
static function_entry php_wxImage_functions[] = {
	...
	PHP_ME(php_wxImage, ComputeHistogram, NULL, ZEND_ACC_PUBLIC)
...
class wxTopLevelWindowBase_php : public wxTopLevelWindowBase
{
	...
	virtual void SetTitle(const wxString& arg0) ;
	virtual wxString GetTitle()  const;
	virtual bool IsIconized()  const;
	virtual bool IsFullScreen()  const;
	virtual bool IsMaximized()  const;
	virtual void Iconize(bool arg0) ;
...
static function_entry php_wxTopLevelWindowBase_functions[] = {
	...
	PHP_ME(php_wxTopLevelWindowBase, IsMaximized, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, SetShape, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, SetMinSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, SetMaxSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, SetIcons, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, SetDefaultItem, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, RequestUserAttention, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxTopLevelWindowBase, Iconize, NULL, ZEND_ACC_PUBLIC)
...
static function_entry php_wxPrinter_functions[] = {
	PHP_ME(php_wxPrinterBase, GetAbort, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxPrinterBase, GetLastError, NULL, ZEND_ACC_PUBLIC)
...
static function_entry php_wxPrintout_functions[] = {
	...
	PHP_ME(php_wxPrintout, OnBeginDocument, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxPrintout, OnEndDocument, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxPrintout, OnBeginPrinting, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxPrintout, OnEndPrinting, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxPrintout, OnPreparePrinting, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
class wxPrintDialogData_php : public wxPrintDialogData
{
	...
	wxPrintDialogData_php(const wxPrintDialogData& arg0):wxPrintDialogData(arg0){}
	wxPrintDialogData_php(const wxPrintData& arg0):wxPrintDialogData(arg0){}
...
static function_entry php_wxListItem_functions[] = {
	...
	PHP_ME(php_wxListItem, GetData, NULL, ZEND_ACC_PUBLIC)
...
#define PHP_wxMenuEvent_NAME "wxMenuEvent"
#define le_wxMenuEvent_name  "native wxMenuEvent"
...
static function_entry php_wxMenuEvent_functions[] = {
	PHP_ME(php_wxEvent, GetId, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, SetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventObject, NULL, ZEND_ACC_PUBLIC)
...
#define PHP_wxMouseEvent_NAME "wxMouseEvent"
#define le_wxMouseEvent_name  "native wxMouseEvent"
...
static function_entry php_wxMouseEvent_functions[] = {
	PHP_ME(php_wxEvent, GetId, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, SetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventObject, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxEvent, ResumePropagation, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, Clone, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxMouseEvent, AltDown, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxMouseEvent, ButtonIsDown, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxMouseEvent, ButtonUp, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxMouseEvent, CmdDown, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxMouseEvent, ControlDown, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxMouseEvent, GetX, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxMouseEvent, GetY, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxMouseEvent, LeftIsDown, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxMouseEvent, MiddleIsDown, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxMouseEvent, RightIsDown, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxMouseEvent, RightUp, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxMouseEvent, ShiftDown, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
#define PHP_wxPaintEvent_NAME "wxPaintEvent"
#define le_wxPaintEvent_name  "native wxPaintEvent"
...
static function_entry php_wxPaintEvent_functions[] = {
	PHP_ME(php_wxEvent, GetId, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, SetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventObject, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxEvent, StopPropagation, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, ResumePropagation, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxPaintEvent, Clone, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
class wxPasswordEntryDialog_php : public wxPasswordEntryDialog
{
	...
	wxPasswordEntryDialog_php(wxWindow* arg0 , const wxString& arg1 , const wxString& arg2 = wxGetPasswordFromUserPromptStr , const wxString& arg3 = wxEmptyString , long int arg4 = 21 , const wxPoint& arg5 = wxDefaultPosition):wxPasswordEntryDialog(arg0 , arg1 , arg2 , arg3 , arg4 , arg5){}
...
class wxTextEntryDialog_php : public wxTextEntryDialog
{
	...
	wxTextEntryDialog_php(wxWindow* arg0 , const wxString& arg1 , const wxString& arg2 = wxGetTextFromUserPromptStr , const wxString& arg3 = wxEmptyString , long int arg4 = 21 , const wxPoint& arg5 = wxDefaultPosition):wxTextEntryDialog(arg0 , arg1 , arg2 , arg3 , arg4 , arg5){}
...
static function_entry php_wxUpdateUIEvent_functions[] = {
	...
	PHP_ME(php_wxCommandEvent, SetInt, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCommandEvent, GetInt, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxUpdateUIEvent, CanUpdate, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxUpdateUIEvent, GetUpdateInterval, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxUpdateUIEvent, ResetUpdateTime, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxUpdateUIEvent, SetMode, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxUpdateUIEvent, SetText, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxUpdateUIEvent, SetUpdateInterval, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxUpdateUIEvent, GetMode, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
#define PHP_wxWindowCreateEvent_NAME "wxWindowCreateEvent"
#define le_wxWindowCreateEvent_name  "native wxWindowCreateEvent"
...
static function_entry php_wxWindowCreateEvent_functions[] = {
	PHP_ME(php_wxEvent, GetId, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, SetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventObject, NULL, ZEND_ACC_PUBLIC)
...
#define PHP_wxWindowDestroyEvent_NAME "wxWindowDestroyEvent"
#define le_wxWindowDestroyEvent_name  "native wxWindowDestroyEvent"
...
static function_entry php_wxWindowDestroyEvent_functions[] = {
	PHP_ME(php_wxEvent, GetId, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, SetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventObject, NULL, ZEND_ACC_PUBLIC)
...
#define PHP_wxPrintDialog_NAME "wxPrintDialog"
#define le_wxPrintDialog_name  "native wxPrintDialog"

class wxPrintDialog_php : public wxPrintDialog
{
	public:

	wxPrintDialog_php(wxWindow* arg0 , wxPrintDialogData* arg1 = 0l):wxPrintDialog(arg0 , arg1){}
	wxPrintDialog_php(wxWindow* arg0 , wxPrintData* arg1):wxPrintDialog(arg0 , arg1){}
...
static function_entry php_wxPrintDialog_functions[] = {
...
class wxIconBundle_php : public wxIconBundle
{
	...
	wxIconBundle_php(const wxIconBundle& arg0):wxIconBundle(arg0){}
...
#define PHP_wxAcceleratorTable_NAME "wxAcceleratorTable"
#define le_wxAcceleratorTable_name  "native wxAcceleratorTable"
...
class wxAcceleratorTable_php : public wxAcceleratorTable
{
	...
	wxAcceleratorTable_php(const wxAcceleratorTable& arg0):wxAcceleratorTable(arg0){}
	wxAcceleratorTable_php(int arg0 , const wxAcceleratorEntry* arg1):wxAcceleratorTable(arg0 , arg1){}
...
static function_entry php_wxAcceleratorTable_functions[] = {
...
#define PHP_wxAcceleratorEntry_NAME "wxAcceleratorEntry"
#define le_wxAcceleratorEntry_name  "native wxAcceleratorEntry"

class wxAcceleratorEntry_php : public wxAcceleratorEntry
{
	public:

	wxAcceleratorEntry_php(int arg0 = 0 , int arg1 = 0 , int arg2 = 0 , wxMenuItem* arg3 = 0l):wxAcceleratorEntry(arg0 , arg1 , arg2 , arg3){}
	wxAcceleratorEntry_php(const wxAcceleratorEntry& arg0):wxAcceleratorEntry(arg0){}
...
static function_entry php_wxAcceleratorEntry_functions[] = {
...
extern zend_class_entry *php_wxXPMHandler_entry;
void php_wxXPMHandler_destruction_handler(zend_rsrc_list_entry * TSRMLS_DC);

#define PHP_wxXPMHandler_NAME "wxXPMHandler"
#define le_wxXPMHandler_name  "native wxXPMHandler"

class wxXPMHandler_php : public wxXPMHandler
{
	public:

	wxXPMHandler_php(const wxXPMHandler& arg0):wxXPMHandler(arg0){}
	wxXPMHandler_php():wxXPMHandler(){}
...
extern int le_wxXPMHandler;

static function_entry php_wxXPMHandler_functions[] = {
	PHP_ME(php_wxXPMHandler, LoadFile, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxXPMHandler, __construct, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
	PHP_ME(php_wxXPMHandler, SaveFile, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};

extern zend_class_entry *php_wxCaretBase_entry;
void php_wxCaretBase_destruction_handler(zend_rsrc_list_entry * TSRMLS_DC);

#define PHP_wxCaretBase_NAME "wxCaretBase"
#define le_wxCaretBase_name  "native wxCaretBase"

class wxCaretBase_php : public wxCaretBase
{
	public:
...
extern int le_wxCaretBase;

static function_entry php_wxCaretBase_functions[] = {
	PHP_ME(php_wxCaretBase, Show, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCaretBase, SetSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCaretBase, Create, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCaretBase, GetPosition, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCaretBase, GetSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCaretBase, GetWindow, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCaretBase, Hide, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCaretBase, IsOk, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCaretBase, IsVisible, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxCaretBase, Move, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
class wxCaret_php : public wxCaret
{
	...
	wxCaret_php(wxWindowBase* arg0 , const wxSize& arg1):wxCaret(arg0 , arg1){}
...
extern zend_class_entry *php_wxWindowList_entry;
void php_wxWindowList_destruction_handler(zend_rsrc_list_entry * TSRMLS_DC);

#define PHP_wxWindowList_NAME "wxWindowList"
#define le_wxWindowList_name  "native wxWindowList"

class wxWindowList_php : public wxWindowList
{
	public:
...
extern int le_wxWindowList;

static function_entry php_wxWindowList_functions[] = {
	PHP_ME(php_wxWindowList, IndexOf, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
#define PHP_wxLayoutConstraints_NAME "wxLayoutConstraints"
#define le_wxLayoutConstraints_name  "native wxLayoutConstraints"
...
static function_entry php_wxLayoutConstraints_functions[] = {
...
static function_entry php_wxArtProvider_functions[] = {
	PHP_ME(php_wxArtProvider, GetBitmap, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxArtProvider, GetIcon, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
#define PHP_wxPrintPreview_NAME "wxPrintPreview"
#define le_wxPrintPreview_name  "native wxPrintPreview"

class wxPrintPreview_php : public wxPrintPreview
{
	public:

	wxPrintPreview_php(wxPrintout* arg0 , wxPrintout* arg1 , wxPrintData* arg2):wxPrintPreview(arg0 , arg1 , arg2){}
...
static function_entry php_wxPrintPreview_functions[] = {
	PHP_ME(php_wxPrintPreviewBase, Print, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxPrintPreviewBase, DetermineScaling, NULL, ZEND_ACC_PUBLIC)
...
#define PHP_wxPreviewCanvas_NAME "wxPreviewCanvas"
#define le_wxPreviewCanvas_name  "native wxPreviewCanvas"

class wxPreviewCanvas_php : public wxPreviewCanvas
{
	public:

	wxPreviewCanvas_php(wxPrintPreviewBase* arg0 , wxWindow* arg1 , const wxPoint& arg2 = wxDefaultPosition , const wxSize& arg3 = wxDefaultSize , long int arg4 = 0 , const wxString& arg5 = wxT("c\000\000\000a\000\000\000n\000\000\000v\000\000\000a\000\000\000s\000\000\000\000\000\000")):wxPreviewCanvas(arg0 , arg1 , arg2 , arg3 , arg4 , arg5){}
...
static function_entry php_wxPreviewCanvas_functions[] = {
	PHP_ME(php_wxPreviewCanvas, OnPaint, NULL, ZEND_ACC_PUBLIC)
...
#define PHP_wxPreviewFrame_NAME "wxPreviewFrame"
#define le_wxPreviewFrame_name  "native wxPreviewFrame"

class wxPreviewFrame_php : public wxPreviewFrame
{
	public:

	wxPreviewFrame_php(wxPrintPreviewBase* arg0 , wxWindow* arg1 , const wxString& arg2 = wxT("P\000\000\000r\000\000\000i\000\000\000n\000\000\000t\000\000\000 \000\000\000P\000\000\000r\000\000\000e\000\000\000v\000\000\000i\000\000\000e\000\000\000w\000\000\000\000\000\000") , const wxPoint& arg3 = wxDefaultPosition , const wxSize& arg4 = wxDefaultSize , long int arg5 = 541072968 , const wxString& arg6 = wxFrameNameStr):wxPreviewFrame(arg0 , arg1 , arg2 , arg3 , arg4 , arg5 , arg6){}
...
static function_entry php_wxPreviewFrame_functions[] = {
	PHP_ME(php_wxPreviewFrame, __construct, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
	...
	PHP_ME(php_wxPreviewFrame, OnCloseWindow, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
#define PHP_wxPreviewControlBar_NAME "wxPreviewControlBar"
#define le_wxPreviewControlBar_name  "native wxPreviewControlBar"

class wxPreviewControlBar_php : public wxPreviewControlBar
{
	public:

	wxPreviewControlBar_php(wxPrintPreviewBase* arg0 , long int arg1 , wxWindow* arg2 , const wxPoint& arg3 = wxDefaultPosition , const wxSize& arg4 = wxDefaultSize , long int arg5 = 524288 , const wxString& arg6 = wxT("p\000\000\000a\000\000\000n\000\000\000e\000\000\000l\000\000\000\000\000\000")):wxPreviewControlBar(arg0 , arg1 , arg2 , arg3 , arg4 , arg5 , arg6){}
...
static function_entry php_wxPreviewControlBar_functions[] = {
	PHP_ME(php_wxPreviewControlBar, __construct, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
	PHP_ME(php_wxPreviewControlBar, GetPrintPreview, NULL, ZEND_ACC_PUBLIC)
...
extern zend_class_entry *php_wxPrintPreviewBase_entry;
void php_wxPrintPreviewBase_destruction_handler(zend_rsrc_list_entry * TSRMLS_DC);

#define PHP_wxPrintPreviewBase_NAME "wxPrintPreviewBase"
#define le_wxPrintPreviewBase_name  "native wxPrintPreviewBase"

class wxPrintPreviewBase_php : public wxPrintPreviewBase
{
	public:

	wxPrintPreviewBase_php(wxPrintout* arg0 , wxPrintout* arg1 , wxPrintData* arg2):wxPrintPreviewBase(arg0 , arg1 , arg2){}

	virtual bool Print(bool arg0) ;
...
extern int le_wxPrintPreviewBase;

static function_entry php_wxPrintPreviewBase_functions[] = {
	PHP_ME(php_wxPrintPreviewBase, __construct, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
	PHP_ME(php_wxPrintPreviewBase, Print, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxPrintPreviewBase, DetermineScaling, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};

extern zend_class_entry *php_wxPrinterBase_entry;
void php_wxPrinterBase_destruction_handler(zend_rsrc_list_entry * TSRMLS_DC);

#define PHP_wxPrinterBase_NAME "wxPrinterBase"
#define le_wxPrinterBase_name  "native wxPrinterBase"

class wxPrinterBase_php : public wxPrinterBase
{
	public:
...
extern int le_wxPrinterBase;

static function_entry php_wxPrinterBase_functions[] = {
	PHP_ME(php_wxPrinterBase, GetAbort, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxPrinterBase, GetLastError, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
...
#define PHP_wxTaskBarIconEvent_NAME "wxTaskBarIconEvent"
#define le_wxTaskBarIconEvent_name  "native wxTaskBarIconEvent"

class wxTaskBarIconEvent_php : public wxTaskBarIconEvent
{
	public:

	wxTaskBarIconEvent_php(const wxTaskBarIconEvent& arg0):wxTaskBarIconEvent(arg0){}
	wxTaskBarIconEvent_php(int arg0 , wxTaskBarIcon* arg1):wxTaskBarIconEvent(arg0 , arg1){}
...
static function_entry php_wxTaskBarIconEvent_functions[] = {
	PHP_ME(php_wxEvent, GetId, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, SetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventType, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxEvent, GetEventObject, NULL, ZEND_ACC_PUBLIC)
...
#define PHP_wxWizardPageSimple_NAME "wxWizardPageSimple"
#define le_wxWizardPageSimple_name  "native wxWizardPageSimple"

class wxWizardPageSimple_php : public wxWizardPageSimple
{
	public:

	wxWizardPageSimple_php(wxWizard* arg0 , wxWizardPage* arg1 = 0u , wxWizardPage* arg2 = 0u , const wxBitmap& arg3 = wxNullBitmap , const wchar_t* arg4 = 0l):wxWizardPageSimple(arg0 , arg1 , arg2 , arg3 , arg4){}
...
static function_entry php_wxWizardPageSimple_functions[] = {
	PHP_ME(php_wxEvtHandler, Connect, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, SetSizer, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, GetSizer, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWindowBase, Layout, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(php_wxWizardPageSimple, Chain, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWizardPageSimple, GetNext, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxWizardPageSimple, GetPrev, NULL, ZEND_ACC_PUBLIC)
	{ NULL, NULL, NULL }
};
