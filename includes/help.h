...
void php_wxHtmlHelpController_destruction_handler(zend_resource * TSRMLS_DC);
...
static inline zo_wxHtmlHelpController * php_wxHtmlHelpController_fetch_object(zend_object *obj) {
      return (zo_wxHtmlHelpController *)((char *)obj - XtOffsetOf(zo_wxHtmlHelpController, zo));
}

#define Z_wxHtmlHelpController_P(zv) php_wxHtmlHelpController_fetch_object(Z_OBJ_P(zv))
extern zend_class_entry* php_wxHtmlModalHelp_entry;
void php_wxHtmlModalHelp_destruction_handler(zend_resource * TSRMLS_DC);
...
static inline zo_wxHtmlModalHelp * php_wxHtmlModalHelp_fetch_object(zend_object *obj) {
      return (zo_wxHtmlModalHelp *)((char *)obj - XtOffsetOf(zo_wxHtmlModalHelp, zo));
}

#define Z_wxHtmlModalHelp_P(zv) php_wxHtmlModalHelp_fetch_object(Z_OBJ_P(zv))
extern zend_class_entry* php_wxHtmlHelpData_entry;
void php_wxHtmlHelpData_destruction_handler(zend_resource * TSRMLS_DC);
...
static inline zo_wxHtmlHelpData * php_wxHtmlHelpData_fetch_object(zend_object *obj) {
      return (zo_wxHtmlHelpData *)((char *)obj - XtOffsetOf(zo_wxHtmlHelpData, zo));
}

#define Z_wxHtmlHelpData_P(zv) php_wxHtmlHelpData_fetch_object(Z_OBJ_P(zv))
extern zend_class_entry* php_wxHtmlHelpDialog_entry;
void php_wxHtmlHelpDialog_destruction_handler(zend_resource * TSRMLS_DC);
...
static inline zo_wxHtmlHelpDialog * php_wxHtmlHelpDialog_fetch_object(zend_object *obj) {
      return (zo_wxHtmlHelpDialog *)((char *)obj - XtOffsetOf(zo_wxHtmlHelpDialog, zo));
}

#define Z_wxHtmlHelpDialog_P(zv) php_wxHtmlHelpDialog_fetch_object(Z_OBJ_P(zv))
extern zend_class_entry* php_wxHtmlHelpFrame_entry;
void php_wxHtmlHelpFrame_destruction_handler(zend_resource * TSRMLS_DC);
...
static inline zo_wxHtmlHelpFrame * php_wxHtmlHelpFrame_fetch_object(zend_object *obj) {
      return (zo_wxHtmlHelpFrame *)((char *)obj - XtOffsetOf(zo_wxHtmlHelpFrame, zo));
}

#define Z_wxHtmlHelpFrame_P(zv) php_wxHtmlHelpFrame_fetch_object(Z_OBJ_P(zv))
extern zend_class_entry* php_wxHtmlHelpWindow_entry;
void php_wxHtmlHelpWindow_destruction_handler(zend_resource * TSRMLS_DC);
...
static inline zo_wxHtmlHelpWindow * php_wxHtmlHelpWindow_fetch_object(zend_object *obj) {
      return (zo_wxHtmlHelpWindow *)((char *)obj - XtOffsetOf(zo_wxHtmlHelpWindow, zo));
}

#define Z_wxHtmlHelpWindow_P(zv) php_wxHtmlHelpWindow_fetch_object(Z_OBJ_P(zv))
extern zend_class_entry* php_wxToolTip_entry;
void php_wxToolTip_destruction_handler(zend_resource * TSRMLS_DC);
...
static inline zo_wxToolTip * php_wxToolTip_fetch_object(zend_object *obj) {
      return (zo_wxToolTip *)((char *)obj - XtOffsetOf(zo_wxToolTip, zo));
}

#define Z_wxToolTip_P(zv) php_wxToolTip_fetch_object(Z_OBJ_P(zv))
