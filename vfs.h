...
#define PHP_wxFileSystem_NAME "wxFileSystem"
#define le_wxFileSystem_name  "native wxFileSystem"
...
static function_entry php_wxFileSystem_functions[] = {
...
#define PHP_wxFileSystemHandler_NAME "wxFileSystemHandler"
#define le_wxFileSystemHandler_name  "native wxFileSystemHandler"
...
static function_entry php_wxFileSystemHandler_functions[] = {
	PHP_ME(php_wxObject, UnShare, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxObject, UnRef, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxObject, IsSameAs, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(php_wxObject, Ref, NULL, ZEND_ACC_PUBLIC)
